  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-[80px] bg-[#FAF7F2]">
        {/* Hero Section */}
        <section className="relative min-h-[716px] flex items-center bg-[#8b1e2c] text-white overflow-hidden">
          <div className="absolute inset-0 opacity-10 pointer-events-none"></div>
          <div className="relative max-w-[1280px] mx-auto px-4 md:px-[40px] grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
            <div className="flex flex-col gap-6">
              ...
              <h1 className="font-['Libre_Franklin'] text-[48px] leading-[56px] font-bold tracking-[-0.02em]">
                Tentang Halo Jurnal
              </h1>
              ...
              <div className="flex gap-4 pt-4">
                <button className="bg-[#fed255] text-[#735a00] px-8 py-4 rounded-lg font-['Public_Sans'] text-[14px] font-semibold tracking-[0.01em] hover:scale-105 transition-transform">
                  Pelajari Visi Kami
                </button>
              </div>
            </div>
              ...
              <div className="w-full md:w-1/2">
                ...
                <div className="space-y-6">
                  <div className="flex gap-6 p-6 bg-white border border-[#debfbf] rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div>
                      <h4 className="font-['Libre_Franklin'] text-[24px] font-semibold text-[#1c1c19] mb-2">Kerahasiaan Data</h4>
                  ...
                  <div className="flex gap-6 p-6 bg-white border border-[#debfbf] rounded-xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div>
                      <h4 className="font-['Libre_Franklin'] text-[24px] font-semibold text-[#1c1c19] mb-2">Transparansi Publik</h4>
                      <p className="font-['Public_Sans'] text-[16px] text-[#574141]">
          ...
          <div className="max-w-[1280px] mx-auto px-4 md:px-[40px]">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="text-center text-white">
                <div className="font-['Libre_Franklin'] text-[48px] leading-[56px] font-bold mb-2 tracking-[-0.02em]">1.240+</div>
                <p className="font-['Public_Sans'] text-[14px] font-semibold opacity-80 uppercase tracking-widest">Laporan Ditindaklanjuti</p>
              </div>
              <div className="text-center text-white">
                <div className="font-['Libre_Franklin'] text-[48px] leading-[56px] font-bold mb-2 tracking-[-0.02em]">98%</div>
                <p className="font-['Public_Sans'] text-[14px] font-semibold opacity-80 uppercase tracking-widest">Tingkat Kepuasan Warga</p>
              </div>
              <div className="text-center text-white">
                <div className="font-['Libre_Franklin'] text-[48px] leading-[56px] font-bold mb-2 tracking-[-0.02em]">24/7</div>
        ...
        <section className="py-24 bg-[#e5e2dd]">
          <div className="max-w-[1280px] mx-auto px-4 md:px-[40px]">
            <div className="bg-white p-12 rounded-2xl shadow-xl flex flex-col md:flex-row justify-between items-center gap-12 border border-[#debfbf]">
              ...
              <div>
                <button className="bg-[#755b00] text-white px-12 py-5 rounded-lg font-['Libre_Franklin'] text-[24px] font-semibold hover:scale-105 active:scale-95 transition-all shadow-lg">
                  Hubungi Kami
                </button>
              </div>
            </div>
