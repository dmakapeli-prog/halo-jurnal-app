      ...
      <main className="min-h-screen pt-[64px] md:pt-[80px] bg-[#FAF7F2]">
        ...
        <section className="max-w-[1280px] mx-auto px-5 md:px-[40px] -mt-12 sm:-mt-16 relative z-30 pb-16 md:pb-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-[24px]">
            ...
            {/* Card 2: Aspirasi */}
            <Link href="/lapor?type=aspirasi" className="bg-white border border-[#debfbf] p-6 md:p-8 rounded-[0.5rem] shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all group cursor-pointer block">
            ...
            {/* Card 3: Informasi */}
            <Link href="/lapor?type=informasi" className="bg-white border border-[#debfbf] p-6 md:p-8 rounded-[0.5rem] shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all group cursor-pointer block">
