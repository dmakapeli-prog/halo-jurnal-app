  ...
  return (
    <>
      ...
      <main className="pt-[80px] min-h-screen flex bg-[#fcf9f4]">
        {/* Sidebar Filters */}
        <aside className="hidden md:flex flex-col w-[280px] fixed left-0 top-[80px] h-[calc(100vh-80px)] bg-[#fcf9f4] border-r border-[#debfbf] p-[40px] overflow-y-auto">
          <div className="mb-8">
        ...
        {/* Feed Canvas */}
        <section className="flex-1 md:ml-[280px] p-[40px] bg-[#fcf9f4]">
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
              <div>
                <h1 className="font-['Libre_Franklin'] text-[48px] leading-[56px] font-bold text-[#1c1c19] mb-2">Feed Publik</h1>
                <p className="font-['Public_Sans'] text-[18px] text-[#574141] max-w-xl">Melihat transparansi dalam setiap aduan. Seluruh identitas pelapor telah disamarkan demi keamanan.</p>
              </div>
              <div className="flex items-center bg-[#f0ede9] rounded-full px-4 py-2 border border-[#debfbf]">
                <span className="material-symbols-outlined text-[#574141] mr-2">search</span>
                <input 
                  type="text" 
                  placeholder="Cari aduan..." 
                  className="bg-transparent border-none focus:ring-0 font-['Public_Sans'] text-[16px] text-[#1c1c19] w-full md:w-48 outline-none"
                  value={searchQuery}
              ...
              {loading ? (
                ...
                reports.map(report => (
                  <article key={report.id} className="bg-white border border-[#debfbf] rounded-xl p-6 transition-all hover:shadow-md hover:-translate-y-1">
                    ...
                    <h3 className="font-['Libre_Franklin'] text-[24px] font-semibold text-[#6b0218] mb-3">{report.judul}</h3>
